...
import 'package:hitbabe/Screens/UpdateLocation.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          leading: IconButton(
            ...
            color: Colors.white,
            onPressed: () => {Navigator.pop(context), _ads.disable(_ad)},
          ),
          elevation: 0,
          backgroundColor: primaryColor),
      body: Container(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      Share.share(
                          'check out my App https://hitbabe.com', //Replace with your dynamic link and msg for invite users
                          subject:
                              'Install HitBabe now to get perfect Match for yourself!');
                    },
                  ),
                ),
                // Padding(
                ...
                Material(
                  child: ListTile(
                    ...
                    trailing: IconButton(
                      ...
                      onPressed: () =>
                          {Navigator.pop(context), _ads.disable(_ad)},
                    ),
                    subtitle: Card(
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
