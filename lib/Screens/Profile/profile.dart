...
import 'package:hitbabe/Screens/Payment/paymentDetails.dart';
import 'package:hitbabe/Screens/Profile/EditProfile.dart';
import 'package:hitbabe/Screens/Profile/settings.dart';
...
final List adds = [
  ...
  },
  {
    ...
    'subtitle': "Passport to anywhere with HitBabe",
  },
  {
    'icon': Icons.vpn_key,
    'color': Colors.orange,
...
class CurvePainter extends CustomPainter {
  void paint(Canvas canvas, Size size) {
    ...
    paint.color = Colors.amber.withOpacity(.4);
