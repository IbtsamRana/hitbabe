...
import 'package:hitbabe/Screens/Payment/subscriptions.dart';
          ...
          InkWell(
            onTap: () => showDialog(
                ...
                builder: (BuildContext context) => CupertinoAlertDialog(
                      title: new Text("Find Your People to Match"),
                      content: new Text(
                          "You can see more people here to find your best Match by increasing the Maximum distance from settings"),
                    )),
            child: Padding(
                                  ...
                                  onSwipe: (int index,
                                    ...
                                    if (position == SwiperPosition.Left) {
                                      ...
                                      // }
                                        ...
                                        SwiperPosition.Right) {
                                      if (likedByList
                                          .contains(widget.users[index].name)) {
                                        showDialog(
                                            context: context,
                                            builder: (ctx) {
                                              Future.delayed(
                                      ...
                                      await docRef
                                          ...
                                          .setData(
                                        {
                                          'LikedBy': widget.currentUser.name,
                                          'timestamp':
                                              FieldValue.serverTimestamp()
                                        },
                                      );
